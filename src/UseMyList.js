...
function UseMyList(){
    ...
    <div className="d-flex justify-content-center pt-1">
        ...
        <button className="btn btn-success p-2 m-2" onClick={() => {
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-plus-circle-fill" viewBox="0 0 15 20">
        ...
        <div className="col-6">
          ...
          <button className="btn btn-danger" onClick={() => {
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 18">
